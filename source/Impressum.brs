...
Function showImpressumScreen2()
    ...
    screen.SetTitle("Impressum")
    screen.AddHeaderText("Inhalt")
    screen.AddParagraph("Chefredaktion" + CHR(10) + "Dr. Kai Gniffke" + CHR(10) + "Christian Nitsche" + CHR(10) + "Christiane Krogmann")	
    screen.AddParagraph("Telefon: +49 (0)40 / 4156-0" + CHR(10) + "Fax: +49 (0)40 / 4156-7419" + CHR(10) + "Email: redaktion@tagesschau.de")
    screen.AddParagraph("Verwendete Agenturen: AFP, AP, dpa, Reuters")
    screen.AddButton(1, "Weiter")
    screen.Show()
...
Function showImpressumScreen3() as Integer
    ...
    screen.AddParagraph("Tagesschau Technischer Leiter" + CHR(10) + "webmaster@tagesschau.de")
